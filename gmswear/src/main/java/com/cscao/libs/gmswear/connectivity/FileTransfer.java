 ...
 * On the sender side:
 * <pre>
 * FileTransfer fileTransfer = new FileTransfer.Builder(targetNode)
 ...
 * has been received and saved successfully, they can register a DataConsumer listener and override
 * {@link DataConsumer#onFileReceivedResult(int, String, File, String)}
 * which includes the status, the unique requestId for the transfer, the File object pointing to
 * the
 * saved file and the original name of the file on the sender side:
 * <pre>
 * mWearConsumer = new AbstractDataConsumer() {
 *
 *     public void onFileReceivedResult(int statusCode, String requestId,
 ...
 * </pre>
 * The {@link DataConsumer#onOutputStreamForChannelReady(int, Channel, OutputStream)} listener will
...
public class FileTransfer {
    ...
    private final OnChannelOutputStreamListener mOnChannelOutputStreamListener;
     ...
     * {@link DataConsumer#onInputStreamForChannelOpened} listener to receive an
     * {@link java.io.InputStream} for writing data to. On the receiver node, the client has to
     * register to {@link DataConsumer#onOutputStreamForChannelReady(int, Channel, OutputStream)}
     ...
     */
    public interface OnChannelOutputStreamListener {
    ...
    public static final class Builder {
        ...
        private OnChannelOutputStreamListener mOnChannelOutputStreamListener;
        private GmsWear mGmsWear;

        /**
         * A Builder class to help with the construction of a {@link FileTransfer} object.
         *
         * @param targetNode The {@link Node} to send the file or bytes to.
         */
        public Builder(Node targetNode) {
            mNode = WearUtil.assertNotNull(targetNode, "targetNode");
        }

        /**
         * Builder for nearest node
         */
        public Builder() {
        ...
        public Builder setFile(File file) {
            mFile = WearUtil.assertNotNull(file, "file");
            if (!file.exists()) {
        ...
        /**
         * Sets the listener {@link OnChannelOutputStreamListener} that should
        ...
        public Builder setOnChannelOutputStreamListener(
                OnChannelOutputStreamListener onChannelOutputStreamListener) {
            mOnChannelOutputStreamListener = WearUtil
                    .assertNotNull(onChannelOutputStreamListener,
        ...
        public Builder setOnFileTransferResultListener(
            ...
            mFileTransferResultListener = WearUtil
                    .assertNotNull(nFileTransferRequestListener, "nFileTransferRequestListener");
            return this;
        }

        /**
         * Builds the {@link FileTransfer} object.
         */
